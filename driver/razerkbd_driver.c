...
static void razer_get_report_params(struct usb_device *usb_dev, uint *report_index, uint *response_index, ulong *wait_min, ulong *wait_max)
{
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRED:
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRELESS:
...
static ssize_t razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRED:
        device_type = "Razer BlackWidow V4 Low-Profile TKL HyperSpeed (Wired)";
        break;

    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRELESS:
        device_type = "Razer BlackWidow V4 Low-Profile TKL HyperSpeed (Wireless)";
        break;
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRED) },
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_LOWPROFILE_TKL_HYPERSPEED_WIRELESS) },
