...
class RazerBlackWidowV4LowProfileTKLHyperSpeedWired(_RippleKeyboard):
    """
    Class for the Razer BlackWidow V4 Low-Profile TKL HyperSpeed [Orange Tactile Switch] (Wired)
    """
    EVENT_FILE_REGEX = re.compile(r'.*Razer_Razer_BlackWidow_V4_LowProfile_TKL_HyperSpeed(-if01)?-event-kbd')
...
class RazerBlackWidowV4LowProfileTKLHyperSpeedWireless(RazerBlackWidowV4LowProfileTKLHyperSpeedWired):
    """
    Class for the Razer BlackWidow V4 Low-Profile TKL HyperSpeed [Orange Tactile Switch] (Wireless)
    """
    EVENT_FILE_REGEX = re.compile(r'.*Razer_Razer_BlackWidow_V4_LowProfile_TKL_HyperSpeed(_\d+)?(-if01)?-event-kbd')
    USB_PID = 0x02D2
